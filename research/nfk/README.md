...
python -m nfk.data.download --dataset all --output research/nfk/datasets

# 仅下载 ASSISTments
python -m nfk.data.download --dataset assistments --output research/nfk/datasets

# 仅下载 EdNet
python -m nfk.data.download --dataset ednet --output research/nfk/datasets
```
...
# ASSISTments 2009
python -m nfk.train \
  --config research/nfk/configs/ablation.yaml \
  --data research/nfk/datasets/assistments2009/skill_builder_data_corrected.csv \
...
python -m nfk.train \
  --config research/nfk/configs/ablation.yaml \
  --data research/nfk/datasets/ednet \
  --data-format ednet \
  --seed 42 --fold 0
```
...
config = NFKConfig.from_yaml("research/nfk/configs/ablation.yaml")
