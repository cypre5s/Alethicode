...
用法:
  # 单次训练
  python -m nfk.train --config research/nfk/configs/ablation.yaml --data path/to/data.csv

  # 完整消融实验
  python -m nfk.train --config research/nfk/configs/ablation.yaml --data path/to/data.csv --ablation
"""
